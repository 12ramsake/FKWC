...
for(N1 in c(50,100)){
  ...
  # for(dist in c("t")){
    for(betai in 1:15){
      beta=tmp[betai]
      fileName=paste0("FKWCResults/dist_",dist,"_noderiv_depths_k_exp_alpha1_p05_p05_p05_beta_p5_p",betai,"_p5_N_",N1,"_num_runs_200.Rda",sep="")
  ...
  # for(dist in c("t")){
    for(alphai in 1:15){
      alpha=tmp[alphai]
      fileName=paste0("FKWCResults/dist_",dist,"_noderiv_depths_k_exp_alpha1_p05_",alphai,"_p05_beta_p5_p5_p5_N_",N1,"_num_runs_200.Rda",sep="")
