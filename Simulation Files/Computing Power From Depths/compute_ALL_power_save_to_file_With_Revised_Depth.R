...
for(N1 in c(50,100,250)){
  for(dist in c("N","t","sn")){
    for(betai in 1:15){
      ...
      fileName=paste0("REVISION_RESULTS/sim_td/dist_", dist,"_deriv_SIM_TD_k_exp_alpha1_p05_p05_beta_p", betai, "_p5_N_",N1,"_num_runs_200.Rda", sep = "")
      load(fileName)
      depth_values1=depth_values
      
      
      fileName=paste0("REVISION_RESULTS/LTR/dist_",dist,"_deriv_LTR_k_exp_alpha1_p05_p05_beta_p",betai,"_p5_N_",N1,"_num_runs_200.Rda",sep="")
      load(fileName)
      depth_values2=depth_values
      
      for(i in 1:num_runs){
        depth_values1[[i]][,2]= depth_values2[[i]]
      }
      ...
      test_stats=lapply(depth_values,getKWPM_all_depth,groups=c(1,N1+1),r=1,k=2,N=N1+N2)
      crit=qchisq(.95,1)
    ...
    print(prop_rejs)
    FN=paste0("Power Files/dist_",dist,"_All_power_rev_k_exp_beta_N_",N1,"J_2_num_runs_200.Rda",sep="")
...
for(N1 in c(50,100,250)){
  for(dist in c("N","t","sn")){
    for(alphai in 1:15){
      ...
      fileName=paste0("REVISION_RESULTS/sim_td/dist_",dist,"_deriv_SIM_TD_k_exp_alpha_p05_",alphai,"_beta_p5_p5_N_",N1,"_num_runs_200.Rda",sep="")
      load(fileName)
      depth_values1=depth_values
      
      fileName=paste0("REVISION_RESULTS/LTR/dist_",dist,"_deriv_LTR_k_exp_alpha_p05_",alphai,"_beta_p5_p5_N_",N1,"_num_runs_200.Rda",sep="")
      load(fileName)
      depth_values2=depth_values
...
#NO DERIVATIVE
    ...
    print(prop_rejs)
    FN=paste0("Power Files/dist_",dist,"_All_power_rev_k_exp_alpha_N_",N1,"J_2_num_runs_200.Rda",sep="")
...
for(N1 in c(50,100)){
  for(dist in c("N","t","sn")){
    for(betai in 1:15){
      ...
      fileName=paste0("REVISION_RESULTS/sim_td/dist_",dist,"_deriv_SIM_TD_k_exp_alpha1_p05_p05_p05_beta_p5_p",betai,"_p5_N_",N1,"_num_runs_200.Rda",sep="")
      load(fileName)
      depth_values1=depth_values
      
      fileName=paste0("REVISION_RESULTS/LTR/dist_",dist,"_deriv_LTR_k_exp_alpha1_p05_p05_p05_beta_p5_p",betai,"_p5_N_",N1,"_num_runs_200.Rda",sep="")
      load(fileName)
      depth_values2=depth_values
      ...
      #KW
      test_stats=lapply(depth_values,getKWPM_all_depths,groups=c(1,N1+1,N1+N2+1),1,3,N1+N2+N3)
      ...
      ####PM
      test_stats=lapply(depth_values,getKWPM_all_depths,groups=c(1,N1+1,N1+N2+1),0.8,3,N1+N2+N3)
    ...
    bet=matrix(tmp,ncol=ncol(prop_rejs),nrow=nrow(prop_rejs))
    print(prop_rejs)
    FN=paste0("Power Files/dist_",dist,"_All_power_rev_k_exp_beta_N_",N1,"J_3_num_runs_200.Rda",sep="")
    save(bet,prop_rejs,file=FN)
    prop_rejs=NULL
  }
}
...
for(N1 in c(50,100)){
  for(dist in c("N","t","sn")){
    for(alphai in 1:15){
      ...
      fileName=paste0("REVISION_RESULTS/sim_td/dist_",dist,"_deriv_SIM_TD_k_exp_alpha1_p05_",alphai,"_p05_beta_p5_p5_p5_N_",N1,"_num_runs_200.Rda",sep="")
      load(fileName)
      depth_values1=depth_values
      
      
      fileName=paste0("REVISION_RESULTS/LTR/dist_",dist,"_deriv_LTR_k_exp_alpha1_p05_",alphai,"_p05_beta_p5_p5_p5_N_",N1,"_num_runs_200.Rda",sep="")
      load(fileName)
      depth_values2=depth_values
    ...
    alp=matrix(tmp,ncol=ncol(prop_rejs),nrow=nrow(prop_rejs))
    print(prop_rejs)
    FN=paste0("Power Files/dist_",dist,"_All_power_rev_k_exp_alpha_N_",N1,"J_3_num_runs_200.Rda",sep="")
    save(alp,prop_rejs,file=FN)
    prop_rejs=NULL
  }
}
...
for(N1 in c(50,100)){
  ...
  for(scen in scens){
    ...
    fileName=paste0("EIGENVALUE/allD_dist_N_deriv_depths_k_eigen_",scen,"_samesum_N_",N1,"_num_runs_200.Rda",sep="")
    load(fileName)
    # nams=names(depth_values[[1]])
    # nams=c(nams,'RPD_Like')
    # for(i in 1:num_runs){
    ...
    fileName=paste0("EIGENVALUE/allD_dist_N_noderiv_depths_k_eigen_",scen,"_samesum_N_",N1,"_num_runs_200.Rda",sep="")
    load(fileName)
    ...
    fileName=paste0("EIGENVALUE/other/other_dist_N_k_eigen_",scen,"_samesum_N_",N1,"_num_runs_200.Rda",sep="")
    load(fileName)
    # pvalues=do.call(rbind, p_values)
    pvalues=p_values
