...
for(dist in c("N","t",'sn')){
  for(betai in 1:15){
    ...
    fileName=paste0("REVISION_RESULTS/RPD_Diff_Dir/Directions_",M,"_dist_",dist,"_deriv_depths_k_exp_alpha1_p05_p05_beta_p",betai,"_p5_N_",N1,"_num_runs_200.Rda",sep="")
    load(fileName)
    ...
    #
    prop_rejz=c(prop_rejz,prop_rej)
    
    }
    prop_rejs=rbind(prop_rejs,prop_rejz)
    colnames(prop_rejs)=c("RPD_50","RPD_Like_50","RPD_75","RPD_Like_75","RPD_100","RPD_Like_100")
  }
  bet=matrix(tmp,ncol=ncol(prop_rejs),nrow=nrow(prop_rejs))
  print(prop_rejs)
  FN=paste0("Power Files/Directions_dist_",dist,"_All_power_rev_k_exp_beta_N_",N1,"J_2_num_runs_200.Rda",sep="")
...
for(dist in c("N","t",'sn')){
  for(alphai in 1:15){
    ...
    fileName=paste0("REVISION_RESULTS/RPD_Diff_Dir/Directions_",M,"_dist_",dist,"_deriv_depths_k_exp_alpha_p05_",alphai,"_beta_p5_p5_N_",N1,"_num_runs_200.Rda",sep="")
    load(fileName)
  ...
  print(prop_rejs)
  FN=paste0("Power Files/Directions_dist_",dist,"_All_power_rev_k_exp_alpha_N_",N1,"J_2_num_runs_200.Rda",sep="")
