...
#   # registerDoRNG(seed = 440)
#   
#   depth_values=try({foreach(i=1:num_runs) %do% {simulate_mv_depths(both,out,contamination_level,N1,N2,b1,b2)}})
#   
#   errorsp=inherits(depth_values, "try-error")
#   if(errorsp){
#     print("there was an error!")
...
for(both in c(T,F)){
  for(out in 1:4){
    ...
    fileName=paste0("cl_",cl,"_both_",both,"_out_",out,"_allD_dist_N_noderiv_depths_k_eigen_1_samesum_N_",N1,"_num_runs_200.Rda",sep="")
    runMVSim(both,out,contamination_level,N1,N2,b1,b2,grid,num_runs,fileName)
    
    b1=1:11
    b2=11:1
    fileName=paste0("cl_",cl,"_both_",both,"_out_",out,"_allD_dist_N_noderiv_depths_k_eigen_2_samesum_N_",N1,"_num_runs_200.Rda",sep="")
    runMVSim(both,out,contamination_level,N1,N2,b1,b2,grid,num_runs,fileName)
    
    b1=2^b1
    b2=2^b2
    fileName=paste0("cl_",cl,"_both_",both,"_out_",out,"_allD_dist_N_noderiv_depths_k_eigen_3_samesum_N_",N1,"_num_runs_200.Rda",sep="")
    runMVSim(both,out,contamination_level,N1,N2,b1,b2,grid,num_runs,fileName)
    ...
    fileName=paste0("cl_",cl,"_both_",both,"_out_",out,"_allD_dist_N_noderiv_depths_k_eigen_21_samesum_N_",N1,"_num_runs_200.Rda",sep="")
    runMVSim(both,out,contamination_level,N1,N2,b1,b2,grid,num_runs,fileName)
    
    b1=1:11
    b2=b1*1.5
    fileName=paste0("cl_",cl,"_both_",both,"_out_",out,"_allD_dist_N_noderiv_depths_k_eigen_22_samesum_N_",N1,"_num_runs_200.Rda",sep="")
    runMVSim(both,out,contamination_level,N1,N2,b1,b2,grid,num_runs,fileName)
    
    b1=2^b1
    b2=b1*1.5
    fileName=paste0("cl_",cl,"_both_",both,"_out_",out,"_allD_dist_N_noderiv_depths_k_eigen_23_samesum_N_",N1,"_num_runs_200.Rda",sep="")
    runMVSim(both,out,contamination_level,N1,N2,b1,b2,grid,num_runs,fileName)
