...
for (N1 in c(50,100,250)){
  ...
  for(dist in c("N","t","sn")){
    for(betai in 2:6){
      beta=tmp[betai]
      fileName=paste0("FKWCResults/o_spat_dist_",dist,
                      "_noderiv_depths_k_exp_alpha1_p05_p05_beta_p",betai,
                      "_p5_N_",N1,"_num_runs_",num_runs,".Rda",sep="")
  ...
  for(dist in c("N","t","sn")){
    for(alphai in 2:6){
      alpha=tmp[alphai]
      fileName=paste0("FKWCResults/o_spat_dist_",dist,"_noderiv_depths_k_exp_alpha1_p05_",
                      alphai,"_beta_p5_p5_N_",N1,"_num_runs_",num_runs,".Rda",sep="")
