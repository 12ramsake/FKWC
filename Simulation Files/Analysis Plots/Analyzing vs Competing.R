...
make_Plots=function(xs=bet,leg=T){
  ...
  matplot(xs[,c(1:5,19:26)],prop_rejs[,c(1:5,19:26)],type='l',
...
make_Plots();  sizes=prop_rejs[1,c(1:5,19:26)]
...
for(N1 in c(50,100)){
  ...
  t_pr_2=cbind(t_pr_2,t_pr[c(1:5,19:26),])
...
make_Plots=function(xs=bet,leg=T){
  ...
  matplot(xs[,c(1:5,11:18)],prop_rejs[,c(1:5,11:18)],type='l',
          col=c(rep(cols[1],5),rep(cols[2],8)),
          lty=c(1:5,1:8),
          lw=5,bty="n",
          cex.axis=2,main="",
          ...
          xlab="")
  if(leg)
    legend("bottomright",legend=colnames(prop_rejs)[c(1:5,11:18)],lty=c(1:5,11:18),col=c(rep(cols[1],5),rep(cols[2],8)),lwd=3,cex=2)
}
