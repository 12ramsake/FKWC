...
for(N1 in c(50,100)){
  for(ratio in c(0.4,0.6,0.8)){
    ...
    # for(dist in c("t")){
      for(betai in c(7,15)){
        beta=tmp[betai]
        fileName=paste0("dist_",dist,"_other_k_exp_alpha1_p05_p05_p05_beta_p5_p",betai,"_p5_N1_",N1,"_N2_",N2,"_N3_",N3,"_num_runs_200.Rda",sep="")
    ...
    # for(dist in c("t")){
      for(alphai in c(7,15)){
        alpha=tmp[alphai]
        fileName=paste0("dist_",dist,"_other_k_exp_alpha1_p05_",alphai,"_p05_beta_p5_p5_p5_N1_",N1,"_N2_",N2,"_N3_",N3,"_num_runs_200.Rda",sep="")
