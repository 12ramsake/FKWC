...
for(N in c(50,100,250)*2){
  ...
  for(dist in c("N","t","sn")){
    for(betai in c(7,15)){
      beta=tmp[betai]
      fileName=paste0("FKWCResults/dist_",dist,"_noderiv_depths_k_exp_alpha1_p05_p05_beta_p",betai,"_p5_N1_",N1,"_N2_",N2,"_num_runs_200.Rda",sep="")
  ...
  for(dist in c("N","t","sn")){
    for(alphai in c(7,15)){
      alpha=tmp[alphai]
      fileName=paste0("FKWCResults/dist_",dist,"_noderiv_depths_k_exp_alpha1_p05_",alphai,"_beta_p5_p5_N1_",N1,"_N2_",N2,"_num_runs_200.Rda",sep="")
...
#     for(betai in 1){
#       beta=tmp[betai]
#       fileName=paste0("FKWCResults/dist_",dist,"_noderiv_depths_k_exp_alpha1_p05_p05_beta_p",betai,"_p5_N_",N1,"_num_runs_200.Rda",sep="")
#       k2=function(t1,t2){k_exp(t1,t2,beta,.05)}
#       c2=getCov(grid,k2)
#       runMVSim(N1,N2,c1,c2,grid,num_runs,fileName,dist=dist)
#       count=count+1
...
#     for(alphai in 1){
#       alpha=tmp[alphai]
#       fileName=paste0("FKWCResults/dist_",dist,"_noderiv_depths_k_exp_alpha1_p05_",alphai,"_beta_p5_p5_N_",N1,"_num_runs_200.Rda",sep="")
#       k2=function(t1,t2){k_exp(t1,t2,0.5,alpha)}
#       c2=getCov(grid,k2)
#       runMVSim(N1,N2,c1,c2,grid,num_runs,fileName,dist=dist)
#       count=count+1
