...
# 
# fileName=paste0("other_dist_N_k_eigen_samesum__N1_",N1,"_N2_",N2,"_num_runs_200.Rda",sep="")
# 
# b1=c(1,2,3)
# b2=c(3,2,1)
...
for(N in c(50,100)*2){
  for(ratio in c(0.2,0.3,0.4)){
    ...
    fileName=paste0("other_dist_N_k_eigen_1_samesum__N1_",N1,"_N2_",N2,"_num_runs_200.Rda",sep="")
    runMVSim(N1,N2,b1,b2,grid,num_runs,fileName)
    
    b1=1:11
    b2=11:1
    fileName=paste0("other_dist_N_k_eigen_2_samesum__N1_",N1,"_N2_",N2,"_num_runs_200.Rda",sep="")
    runMVSim(N1,N2,b1,b2,grid,num_runs,fileName)
    
    b1=2^b1
    b2=2^b2
    fileName=paste0("other_dist_N_k_eigen_3_samesum__N1_",N1,"_N2_",N2,"_num_runs_200.Rda",sep="")
    runMVSim(N1,N2,b1,b2,grid,num_runs,fileName)
    ...
    fileName=paste0("other_dist_N_depths_k_eigen_21_samesum__N1_",N1,"_N2_",N2,"_num_runs_200.Rda",sep="")
    runMVSim(N1,N2,b1,b2,grid,num_runs,fileName)
    
    b1=1:11
    b2=b1*1.5
    fileName=paste0("other_dist_N_depths_k_eigen_22_samesum__N1_",N1,"_N2_",N2,"_num_runs_200.Rda",sep="")
    runMVSim(N1,N2,b1,b2,grid,num_runs,fileName)
    
    b1=2^b1
    b2=b1*1.5
    fileName=paste0("other_dist_N_depths_k_eigen_23_samesum__N1_",N1,"_N2_",N2,"_num_runs_200.Rda",sep="")
    runMVSim(N1,N2,b1,b2,grid,num_runs,fileName)
