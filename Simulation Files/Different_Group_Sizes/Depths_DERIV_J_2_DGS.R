...
for(N in c(50,100,250)*2){
  ...
  for(dist in c("N","t","sn")){
    for(betai in c(7,15)){
      beta=tmp[betai]
      fileName=paste0("FKWCResults/dist_",dist,"_deriv_SIM_TD_k_exp_alpha1_p05_p05_beta_p",betai,"_p5_N1_",N1,"_N2_",N2,"_num_runs_200.Rda",sep="")
  ...
  for(dist in c("N","t","sn")){
    for(alphai in c(7,15)){
      alpha=tmp[alphai]
      fileName=paste0("FKWCResults/dist_",dist,"_deriv_SIM_TD_k_exp_alpha_p05_",alphai,"_beta_p5_p5_N1_",N1,"_N2_",N2,"_num_runs_200.Rda",sep="")
