...
fileName=paste0("allD_dist_N_deriv_depths_k_eigen_1_samesum_N_",N1,"_num_runs_200.Rda",sep="")
runMVSim(N1,N2,b1,b2,grid,num_runs,fileName)

b1=1:11
b2=11:1
fileName=paste0("allD_dist_N_deriv_depths_k_eigen_2_samesum_N_",N1,"_num_runs_200.Rda",sep="")
runMVSim(N1,N2,b1,b2,grid,num_runs,fileName)

b1=2^b1
b2=2^b2
fileName=paste0("allD_dist_N_deriv_depths_k_eigen_3_samesum_N_",N1,"_num_runs_200.Rda",sep="")
runMVSim(N1,N2,b1,b2,grid,num_runs,fileName)
...
fileName=paste0("allD_dist_N_deriv_depths_k_eigen_21_samesum_N_",N1,"_num_runs_200.Rda",sep="")
runMVSim(N1,N2,b1,b2,grid,num_runs,fileName)

b1=1:11
b2=b1*1.5
fileName=paste0("allD_dist_N_deriv_depths_k_eigen_22_samesum_N_",N1,"_num_runs_200.Rda",sep="")
runMVSim(N1,N2,b1,b2,grid,num_runs,fileName)

b1=2^b1
b2=b1*1.5
fileName=paste0("allD_dist_N_deriv_depths_k_eigen_23_samesum_N_",N1,"_num_runs_200.Rda",sep="")
runMVSim(N1,N2,b1,b2,grid,num_runs,fileName)
