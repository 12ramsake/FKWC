...
runMVSim<-function(N1=10,N2=10,N3=10,
                   Cov1,
                   Cov2,
                   Cov3, grid,num_runs,fileName,dist="t",del=0.9){
  ...
  depth_values=try({foreach(i=1:num_runs) %dopar% {simulate_mv_depths(N1,N2,N3,c1,c2,c3,res=1e2,del=del,dist=dist,grid=grid)}})
