...
for(N1 in c(50,100,250)){
  for(dist in c("N","t","sn")){
    for(betai in 1:15){
      ...
      # if(betai<=6){
      #   fileName=paste0("FKWCResults/OSPAT_D/ospat_dist_",dist,"_deriv_depths_k_exp_alpha1_p05_p05_beta_p",betai,"_p5_N_",N1,"_num_runs_200.Rda",sep="")   
      #   # fileName=paste0("FKWCResults/ospat_dist_",dist,"_deriv_depths_k_exp_alpha1_p05_p05_beta_p",betai,"_p5_N_",N1,"_num_runs_200.Rda",sep="")   
      #   load(fileName)
      #   for(i in 1:length(depth_values))
      #     depth_values[[i]]=cbind(depth_values1[[i]],depth_values[[i]])
      #   
      #   
      #   fileName=paste0("FKWCResults/KSPAT_D/kspat_dist_",dist,"_deriv_depths_k_exp_alpha1_p05_p05_beta_p",betai,"_p5_N_",N1,"_num_runs_200.Rda",sep="")   
      #   # fileName=paste0("FKWCResults/kspat_dist_",dist,"_deriv_depths_k_exp_alpha1_p05_p05_beta_p",betai,"_p5_N_",N1,"_num_runs_200.Rda",sep="")   
      #   load(fileName)
      #   for(i in 1:length(depth_values))
      #     depth_values[[i]]=cbind(depth_values1[[i]],depth_values[[i]])
      #   
      ...
      # }
      # else{
      #   depth_values=lapply(depth_values, function(x){cbind(x,rep(NA,N1*2),rep(NA,N1*2))})
      # }
      ...
      names(prop_rej)=c("FMD","RPD","MBD","LTR","FMD_PM","RPD_PM","MBD_PM","LTR")
      ...
      # if(betai<=6){
      #   fileName=paste0("FKWCResults/OSPAT_D/o_spat_dist_",dist,"_noderiv_depths_k_exp_alpha1_p05_p05_beta_p",betai,"_p5_N_",N1,"_num_runs_200.Rda",sep="")   
      #   # fileName=paste0("FKWCResults/ospat_dist_",dist,"_deriv_depths_k_exp_alpha1_p05_p05_beta_p",betai,"_p5_N_",N1,"_num_runs_200.Rda",sep="")   
      #   load(fileName)
      #   for(i in 1:length(depth_values))
      #     depth_values[[i]]=cbind(depth_values1[[i]],depth_values[[i]])
      #   
      #   
      #   fileName=paste0("FKWCResults/KSPAT_D/kspat_dist_",dist,"_noderiv_depths_k_exp_alpha1_p05_p05_beta_p",betai,"_p5_N_",N1,"_num_runs_200.Rda",sep="")   
      #   # fileName=paste0("FKWCResults/kspat_dist_",dist,"_deriv_depths_k_exp_alpha1_p05_p05_beta_p",betai,"_p5_N_",N1,"_num_runs_200.Rda",sep="")   
      #   load(fileName)
      #   for(i in 1:length(depth_values))
      #     depth_values[[i]]=cbind(depth_values1[[i]],depth_values[[i]])
      ...
      names(prop_rej)=c(names(prop_rej)[1:8],
    ...
    print(prop_rejs)
    FN=paste0("Power Files/dist_",dist,"_All_power_k_exp_beta_N_",N1,"J_2_num_runs_200.Rda",sep="")
...
for(N1 in c(50,100,250)){
  for(dist in c("N","t","sn")){
    for(alphai in 1:15){
      ...
      names(prop_rej)=names(prop_rej)=c("FMD","RPD","MBD","LTR","FMD_PM","RPD_PM","MBD_PM","LTR_PM")
...
#NO DERIVATIVE
    ...
    print(prop_rejs)
    FN=paste0("Power Files/dist_",dist,"_All_power_k_exp_alpha_N_",N1,"J_2_num_runs_200.Rda",sep="")
...
for(N1 in c(50,100)){
  for(dist in c("N","t","sn")){
    ...
    bet=matrix(tmp,ncol=ncol(prop_rejs),nrow=nrow(prop_rejs))
    print(prop_rejs)
    FN=paste0("Power Files/dist_",dist,"_All_power_k_exp_beta_N_",N1,"J_3_num_runs_200.Rda",sep="")
    save(bet,prop_rejs,file=FN)
    prop_rejs=NULL
  }
}
...
for(N1 in c(50,100)){
  for(dist in c("N","t","sn")){
    ...
    alp=matrix(tmp,ncol=ncol(prop_rejs),nrow=nrow(prop_rejs))
    print(prop_rejs)
    FN=paste0("Power Files/dist_",dist,"_All_power_k_exp_alpha_N_",N1,"J_3_num_runs_200.Rda",sep="")
    save(alp,prop_rejs,file=FN)
    prop_rejs=NULL
  }
}
...
for(N1 in c(50,100)){
  ...
  for(scen in scens){
    ...
    names(prop_rej)=c("FMD","RPD","MBD","LTR","SPAT","KSPAT","FMD_PM","RPD_PM","MBD_PM","LTR_PM","SPAT_PM","KSPAT_PM")
    ...
    names(prop_rej)=c(names(prop_rej)[1:12],
                      paste(c("FMD","RPD","MBD","LTR","SPAT","KSPAT","FMD_PM","RPD_PM","MBD_PM","LTR_PM","SPAT_PM","KSPAT_PM"),"_ND",sep=""))
    
    
    
    
    fileName=paste0("EIGENVALUE/other_dist_N_k_eigen_",scen,"_samesum_N_",N1,"_num_runs_200.Rda",sep="")
    load(fileName)
    # pvalues=do.call(rbind, p_values)
    pvalues=p_values

    prop_rej=c(prop_rej,apply(pvalues<0.05,1,mean))
    names(prop_rej)[25:32]=rownames( p_values)
    prop_rejs=rbind(prop_rejs,prop_rej)
    
    
  }
  print(prop_rejs)
  FN=paste0("Power Files/eigen_",dist,"_All_power_N_",N1,"_num_runs_200.Rda",sep="")
  xtable(t(prop_rejs))
